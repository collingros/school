...
{
       0,    67,    67,    73,    76,    87,    90,    96,   109,   127,
     149,   168,   194,   197,   200,   206,   206,   241,   244,   250,
     253,   264,   283,   304,   304,   319,   322,   338,   341,   359,
     362,   365,   368,   371,   374,   377,   380,   386,   389,   395,
     407,   422,   430,   433,   440,   447,   454,   471,   478,   490,
     518,   521,   531,   534,   537,   540,   543,   546,   552,   555,
     574,   577,   583,   586,   596,   599,   602,   605,   612,   615,
     619,   622,   625,   629,   633,   640,   704,   707,   713,   716
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "VOID", "BOOLEAN", "MYBEGIN",
  "END", "IF", "THEN", "ELSE", "WHILE", "DO", "MYRETURN", "READ", "WRITE",
  "AND", "OR", "TRUE", "FALSE", "NOT", "LE", "GE", "EQ", "NEQ", "NUMBER",
  "VARIABLE", "';'", "'['", "']'", "','", "'('", "')'", "'='", "'<'",
  "'>'", "'+'", "'-'", "'*'", "'/'", "$accept", "program", "decList",
  "dec", "varDec", "varList", "typeSpec", "funDec", "$@1", "params",
  "paramList", "param", "compoundStmt", "$@2", "localDec", "stmtList",
  "stmt", "exprStmt", "selectionStmt", "iterationStmt", "returnStmt",
  "readStmt", "writeStmt", "assignmentStmt", "expr", "var", "simpleExpr",
  "relop", "additiveExpr", "addop", "term", "multop", "factor", "call",
...
{
      68,   -94,   -94,   -94,     3,   -94,    68,   -94,   -12,   -94,
     -94,   -94,    48,     8,    65,    25,   -94,   -94,    62,     0,
     -94,    82,    47,    60,    67,    63,   -94,    64,    25,    69,
      90,    68,   -94,    70,   -94,   -94,   -94,   -94,    68,    68,
      25,     7,   -94,    49,    49,    39,    72,    49,   -94,   -94,
      49,   -94,    53,   -94,    49,   -94,    93,     7,   -94,   -94,
     -94,   -94,   -94,   -94,   -94,    74,    71,    26,    52,   -15,
     -94,   -94,    94,   -94,    95,   -94,    75,    77,    79,    81,
     -94,    49,    49,    78,   -94,   -94,   -94,    49,   -94,   -94,
     -94,   -94,   -94,   -94,    49,   -94,   -94,    49,   -94,   -94,
     -94,   -94,    49,     7,     7,   -94,   -94,   -94,    80,    83,
      84,   -94,   -94,    19,    52,   -15,   -15,   101,   -94,   -94,
      49,   -94,   -94,     7,   -94,   -94
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      10,     0,     9,    13,     0,     0,    18,    19,     0,    22,
       ...
       0,    27,    26,     0,     0,     0,     0,     0,    72,    73,
       0,    69,    48,    38,     0,    30,     0,    27,    29,    31,
      32,    34,    35,    36,    33,     0,    70,    47,    50,    58,
      62,    71,     0,    70,     0,    42,     0,    48,     0,     0,
      74,     0,    76,     0,    24,    28,    37,     0,    52,    55,
      56,    57,    53,    54,     0,    60,    61,     0,    66,    67,
      64,    65,     0,     0,     0,    43,    44,    45,     0,    78,
...
{
     -94,   -94,   106,   -94,    17,    24,    -2,   -94,   -94,   -94,
      86,   -94,    85,   -94,    87,    57,   -92,   -94,   -94,   -94,
     -94,   -94,   -94,   -94,   -37,   -41,    31,   -94,    27,   -94,
     -93,   -94,    73,   -94,   -94,    -1
};
...
{
      66,    98,    99,    10,   115,    78,    72,    74,    76,   116,
      79,   117,   118,    34,    12,    43,    66,    83,    44,    24,
      45,    46,    47,   100,   101,    48,    49,    50,    14,    24,
      15,   125,    51,    52,    53,    17,    40,    40,    54,    20,
      88,    89,    90,    91,   108,   109,   122,    88,    89,    90,
      91,    19,    32,    92,    93,    39,    39,    48,    49,    50,
      92,    93,    66,    66,    51,    52,    75,    48,    49,    50,
      54,     1,     2,     3,    51,    52,    14,    28,    15,    16,
      54,    81,    66,   109,    82,     1,    23,     3,    95,    96,
      18,    22,   -17,    29,    31,    30,    34,    33,    77,    37,
      84,    86,   105,   103,    87,    81,   106,   104,   107,   119,
     112,   123,    11,   120,    85,    35,   121,    36,   113,   124,
       0,   114,     0,    80,     0,     0,    42
};

static const yytype_int8 yycheck[] =
{
      41,    16,    17,     0,    97,    46,    43,    44,    45,   102,
      47,   103,   104,     6,    26,     8,    57,    54,    11,    21,
      13,    14,    15,    38,    39,    18,    19,    20,    28,    31,
      30,   123,    25,    26,    27,    27,    38,    39,    31,    15,
      21,    22,    23,    24,    81,    82,    27,    21,    22,    23,
      24,    26,    28,    34,    35,    38,    39,    18,    19,    20,
      34,    35,   103,   104,    25,    26,    27,    18,    19,    20,
      31,     3,     4,     5,    25,    26,    28,    30,    30,    31,
      31,    28,   123,   120,    31,     3,     4,     5,    36,    37,
      25,    29,    32,    26,    30,    32,     6,    28,    26,    29,
       7,    27,    27,     9,    33,    28,    27,    12,    27,    29,
      32,    10,     6,    30,    57,    30,    32,    31,    87,   120,
      -1,    94,    -1,    50,    -1,    -1,    39
};
...
static const yytype_uint8 yystos[] =
{
      ...
      45,    48,    29,     4,    46,    49,    50,    51,    30,    26,
      32,    30,    45,    28,     6,    52,    50,    29,    53,    44,
      46,    54,    54,     8,    11,    13,    14,    15,    18,    19,
      20,    25,    26,    27,    31,    52,    55,    56,    57,    58,
      59,    60,    61,    62,    63,    64,    65,    66,    68,    70,
      72,    73,    64,    65,    64,    27,    64,    26,    65,    64,
      72,    28,    31,    64,     7,    55,    27,    33,    21,    22,
      23,    24,    34,    35,    67,    36,    37,    69,    16,    17,
      38,    39,    71,     9,    12,    27,    27,    27,    64,    64,
      74,    75,    32,    66,    68,    70,    70,    56,    56,    29,
      30,    32,    27,    10,    75,    56
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 67 "lab7.y" /* yacc.c:1646  */
    {
			globalTreePointer = (yyvsp[0].node);
		}
#line 1389 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 73 "lab7.y" /* yacc.c:1646  */
    {
...
#line 76 "lab7.y" /* yacc.c:1646  */
    {
			ASTNode *last = ASTfollowNode((yyvsp[-1].node));
...
#line 1426 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 96 "lab7.y" /* yacc.c:1646  */
    {
			(yyval.node) = (yyvsp[-1].node);

			/*	propogate dt across all vars in varList	*/
			for (ASTNode *i = (yyval.node); i != NULL; i = i->next) {
				struct SymbTab *sym = Search(i->name, level, 0);
				sym->Type = (yyvsp[-2].datatype);
				i->dt = (yyvsp[-2].datatype);
			}
		}
...
#line 109 "lab7.y" /* yacc.c:1646  */
    {
			...
			(yyval.node)->sym = Insert((yyvsp[0].string), -1, 0, level, 1, offset, NULL, 0);
...
#line 127 "lab7.y" /* yacc.c:1646  */
    {
			...
			/*	name, type, isafunc, level, mysize, offset, fparams, isarray	*/
			(yyval.node)->sym = Insert((yyvsp[-3].string), -1, 0, level, (yyvsp[-1].number), offset, NULL, 1);
...
#line 149 "lab7.y" /* yacc.c:1646  */
    {
			...
			/*	name, type, isafunc, level, mysize, offset, fparams, isarray	*/
			(yyval.node)->sym = Insert((yyvsp[-2].string), -1, 0, level, 1, offset, NULL, 0);
...
#line 168 "lab7.y" /* yacc.c:1646  */
    {
			...
			/*	name, type, isafunc, level, mysize, offset, fparams, isarray	*/
			(yyval.node)->sym = Insert((yyvsp[-5].string), -1, 0, level, (yyvsp[-3].number), offset, NULL, 1);
...
#line 197 "lab7.y" /* yacc.c:1646  */
    {
				(yyval.datatype) = VOIDTYPE;
			}
#line 1559 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 200 "lab7.y" /* yacc.c:1646  */
    {
				(yyval.datatype) = BOOLEANTYPE;
			}
...
#line 206 "lab7.y" /* yacc.c:1646  */
    {
				...
				Insert((yyvsp[-1].string), (yyvsp[-2].datatype), 1, level, 0, 0, NULL, 0);
...
#line 222 "lab7.y" /* yacc.c:1646  */
    {
				...
				(yyval.node)->name = (yyvsp[-5].string);
				(yyval.node)->dt = (yyvsp[-6].datatype);
				...
				struct SymbTab *s = Search((yyvsp[-5].string), level, 0);
				s->fparms = (yyvsp[-2].node);
				(yyval.node)->sym = s;
...
#line 1633 "y.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 253 "lab7.y" /* yacc.c:1646  */
    {
				ASTNode *last = ASTfollowNode((yyvsp[-2].node));
				/* append the other decList to the end of the last node
				   in this node's next chain */
				last->next = (yyvsp[0].node);
...
#line 264 "lab7.y" /* yacc.c:1646  */
    {
			...
			(yyval.node)->dt = (yyvsp[-3].datatype);
			(yyval.node)->name = (yyvsp[-2].string);

			/*	name, type, isafunc, level, mysize, offset, fparams, isarray	*/
			(yyval.node)->sym = Insert((yyvsp[-2].string), (yyvsp[-3].datatype), 0, level + 1, 1, offset, NULL, 1);
...
#line 283 "lab7.y" /* yacc.c:1646  */
    {
			...
			(yyval.node) = ASTcreateNode(PARAM);
			(yyval.node)->dt = (yyvsp[-1].datatype);
			(yyval.node)->name = (yyvsp[0].string);

			/*	name, type, isafunc, level, mysize, offset, fparams, isarray	*/
			(yyval.node)->sym = Insert((yyvsp[0].string), (yyvsp[-1].datatype), 0, level + 1, 1, offset, NULL, 0);
...
#line 1847 "y.tab.c" /* yacc.c:1646  */
  ...
  case 39:
#line 395 "lab7.y" /* yacc.c:1646  */
    {
					(yyval.node) = ASTcreateNode(MYIF);
					(yyval.node)->s1 = (yyvsp[-2].node);

					ASTNode *elseNode = ASTcreateNode(MYELSE);
					/*	the stmt in the IF	*/
					elseNode->s1 = (yyvsp[0].node);
					/*	the stmt in the ELSE	*/
					elseNode->s2 = NULL;

					(yyval.node)->s2 = elseNode;
				}
#line 1864 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 407 "lab7.y" /* yacc.c:1646  */
    {
					(yyval.node) = ASTcreateNode(MYIF);
					...
					ASTNode *elseNode = ASTcreateNode(MYELSE);
					/*	the stmt in the IF	*/
					elseNode->s1 = (yyvsp[-2].node);
					/*	the stmt in the ELSE	*/
					elseNode->s2 = (yyvsp[0].node);
...
#line 422 "lab7.y" /* yacc.c:1646  */
    {
					(yyval.node) = ASTcreateNode(MYWHILE);
					(yyval.node)->s1 = (yyvsp[-2].node);
					(yyval.node)->s2 = (yyvsp[0].node);
				}
...
#line 430 "lab7.y" /* yacc.c:1646  */
    {
				(yyval.node) = ASTcreateNode(RETURN);
			}
#line 1899 "y.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 433 "lab7.y" /* yacc.c:1646  */
    {
				(yyval.node) = ASTcreateNode(RETURN);
...
#line 454 "lab7.y" /* yacc.c:1646  */
    {
					if (!equalTypes((yyvsp[-3].node), (yyvsp[-1].node), level)) {
						yyerror("ERROR: assignment statement has unequal "
								"types: \n");
						yyerror((yyvsp[-3].node)->name);
...
#line 478 "lab7.y" /* yacc.c:1646  */
    {
		...
		if (Search((yyvsp[0].string), level, 1) == NULL) {
...
#line 1970 "y.tab.c" /* yacc.c:1646  */
  ...
  case 49:
#line 490 "lab7.y" /* yacc.c:1646  */
    {
		/*	check if this var is in the symbol table	*/
		struct SymbTab *s = Search((yyvsp[-3].string), level, 1);
		if (s == NULL) {
			yyerror("ERROR: undefined variable: ");
			yyerror((yyvsp[-3].string));
...
#line 555 "lab7.y" /* yacc.c:1646  */
    {
					...
					/*	if s1's type is equal to s2's type, then we are ok.
						...
						NUMBER node.	*/
					if (!equalTypes((yyvsp[-2].node), (yyvsp[0].node), level)) {
...
#line 2197 "y.tab.c" /* yacc.c:1646  */
  ...
  case 72:
#line 625 "lab7.y" /* yacc.c:1646  */
    {
			(yyval.node) = ASTcreateNode(BOOL);
			(yyval.node)->value = 1;
		}
...
#line 2215 "y.tab.c" /* yacc.c:1646  */
  ...
  case 74:
#line 633 "lab7.y" /* yacc.c:1646  */
    {
			(yyval.node) = ASTcreateNode(MYNOT);
