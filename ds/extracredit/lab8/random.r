...
#random.graph(20000, 1000000, "20k_1m.txt")
#random.graph(40000, 1000000, "40k_1m.txt")
#random.graph(60000, 1000000, "60k_1m.txt")
#random.graph(80000, 1000000, "80k_1m.txt")
#random.graph(100000, 1000000, "100k_1m.txt")
#
#random.graph(50000, 200000, "50k_200k.txt")
#random.graph(50000, 400000, "50k_400k.txt")
#random.graph(50000, 600000, "50k_600k.txt")
#random.graph(50000, 800000, "50k_800k.txt")
#random.graph(50000, 1000000, "50k_1m.txt")

graph.from.file("graphs/d_a.txt")
